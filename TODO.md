...
- [ ] **تفصيل خيارات تملك العربيات + نظام "Ausschreibung" (تقسيط مخصص)** — عند إضافة عربية: اختيار طريقة الحصول عليها (شراء كامل / إيجار مع شراء / ليزينج / تقسيط / إيجار فقط)، وسعر العربية Netto + نسبة MwSt منفصلة. خيار "Ausschreibung": المستخدم يدخل سعر وتاريخ شراء العربية + مدة زمنية (بالشهور) يتفق عليها مع محاسبه، والبرنامج يوزع سعر العربية على المدة دي كمصروف Netto شهري ثابت في المصروفات (بدل ما يتحسب دفعة واحدة، عشان قانون النمسا مايسمحش بخصم مبالغ كبيرة كمصروف مباشر). لو العربية اتباعت قبل أو بعد نهاية المدة، الفرق بين سعر البيع والقيمة المتبقية يتحسب مكسب أو خسارة. **معدل الإهلاك (Depreciation rate) هيتلغي مؤقتًا** من صفحة Assets — تفضل إضافة الأصل من غير حساب إهلاك لحد ما نحسم القصة القانونية/المحاسبية دي.
