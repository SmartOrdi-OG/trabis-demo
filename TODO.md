...
- [ ] **تحديث تقارير المحاسب + Excel/PDF export جديد** — تحديث حسبة UVA وكل التقارير (بما فيها واجهة buchhalter.html) عشان تتساوى مع اللوجيك الجديد. Excel export جديد بيحسب إجمالي Netto وإجمالي MwSt للفترة المحددة بشكل احترافي ومفصل وكامل بكل المعلومات المالية (بدل الشكل الحالي). نفس الشيء لـ PDF export.
