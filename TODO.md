...
- [x] **واجهة تفصيلية لخانتي المصروفات والدخل (بالـ VAT + Saldo)** — ✅ كارتين "مصروفات" و"دخل" في الصفحة الرئيسية بدل Total Income/Total Expenses القدام (وشيل كارتي الديون المعلقة والفواتير المتأخرة خالص). كل كارت بيعرض إجمالي Netto وإجمالي MwSt للفترة المختارة (اليوم/أسبوع/شهر/سنة/مخصص). الضغط على الكارت الكبير نفسه (مش زرار تحته) بيفتح ليستة تفصيلية بكل عنصر (الاسم، التاريخ، Netto، MwSt، الإجمالي) مرتبة الأكبر أولاً + إجمالي الفترة فوق. كارت "Saldo" بيوضح الفرق بين MwSt الدخل والمصروفات (Zahllast/Guthaben بلون أحمر/أخضر). خانة نسبة الضريبة في فورم إضافة/تعديل المعاملة بقت خانة رقم يدوية بالكامل (اتشالت أزرار 0/10/13/20% الجاهزة) — تدعم أي نسبة لدعم الشراء من دول تانية.
