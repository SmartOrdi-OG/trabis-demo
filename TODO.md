...
- [ ] **واجهة تفصيلية لخانتي المصروفات والدخل (بالـ VAT + Saldo)** — كارت "مصروفات" وكارت "دخل"، كل واحد فيه زرارين (إجمالي Netto / إجمالي MwSt) حسب الفترة الزمنية المختارة. الضغط على أي زرار بيفتح ليستة تفصيلية بكل عنصر (وصف + إجمالي بتاعه) عشان المستخدم يعرف بيصرف فين أو بيبيع إيه أكتر. حساب "Saldo" = الفرق بين MwSt الدخل و MwSt المصروفات للفترة دي (يوضح لو المستخدم دائن أو مديون للدولة). نسبة الضريبة تتكتب يدوي لكل عنصر في الاتنين (مش بس من قايمة ثابتة) عشان تدعم شراء بنسب ضريبة من دول تانية غير النمسا.
