...
- [ ] **تسجيل ساعات عمل حر بشيت شهري** — من بروفايل الموظف، المستخدم يختار الشهر فتتفتحله شيت (شبه الملحق: تاريخ / بداية / نهاية / استراحة بالدقايق / إجمالي ساعات) يملاها بحرية كاملة ويعدل فيها في أي وقت. الاستراحة متتحسبش من ساعات العمل. الإجمالي الشهري بيتجمع أوتوماتيك. إمكانية تنزيل الشيت PDF في أي وقت.
...
- **v1.5.1** = تعديلات بعد فيدباك البايلوت (تصحيح حساب الضريبة + واجهة المصروفات/الدخل + العربيات + ساعات العمل + التقارير) — جاري العمل عليها الآن
