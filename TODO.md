...
- [ ] **تصحيح لوجيك حساب الضريبة (Netto-based)** — اللوجيك الحالي غلط. الصح (زي أي فاتورة نمساوية رسمية): الـ MwSt % بتتحسب من الـ **Netto**، مش من الـ Brutto (يعني Netto + Steuer = Brutto، مش العكس). لازم يتصحح في كل مكان بيتحسب فيه: خانة النسبة في المعاملات، معاينة Netto/Steuer، تقرير UVA، وأي مكان تاني بيستخدم vatRate. يتطبق على كل النسب الحالية والمستقبلية.
