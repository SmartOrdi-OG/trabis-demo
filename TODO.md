...
- [ ] **ربط المصروفات الثابتة والمرتبات بخانة المصروفات الجديدة** — لازم تظهر تفصيليًا جوا خانة "مصروفات" الجديدة (البند 2). المرتبات دايمًا Netto من غير MwSt خالص. المصروفات الثابتة (Recurring) المستخدم يحدد لكل واحدة لو عليها MwSt ولا لأ.
